#!/usr/bin/env python3
"""
Module to build a decision tree from scratch with custom bounds propagation.
"""
import numpy as np
...
class Leaf(Node):
    ...
    def update_bounds_below(self):
        """
        Leaves have no children to update bounds for.
        """
        pass
...
class Decision_Tree():
    ...
    def update_bounds(self):
        """
        Triggers the recursive boundary calculation from the root.
        """
